...
ttk.Label(marcoPrincipal, textvariable=metros).grid(
    column=2, row=2, sticky=(W, E))
ttk.Button(marcoPrincipal, text="Calcular",
           command=calcular).grid(column=3, row=3, sticky=W)

ttk.Label(marcoPrincipal, text="Pies").grid(column=3, row=1, sticky=W)
ttk.Label(marcoPrincipal, text="Es equivalente a: ").grid(
